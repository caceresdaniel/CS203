...
public class GUI extends Application {
	...
	public void colorSetter(List<Hexagon> hexagons, PositionTracker p) {
		...
		System.out.println(RecursiveSolver.p.getInPosOne());
		System.out.println(RecursiveSolver.p.getInPosTwo());
		System.out.println(RecursiveSolver.p.getInPosThree());
		System.out.println(RecursiveSolver.p.getInPosFour());
		System.out.println(RecursiveSolver.p.getInPosFive());
